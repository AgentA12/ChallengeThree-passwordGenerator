...
generatePassword = function(){
 ...
 var newPassword = applyPasswordDetails(passLengthBool, passlowercaseBool, passuppercaseBool, passnumericBool, passspecialBool)
 return newPassword;
}
...
var passwordDetailsLowercase = function(){
  ...
  lowercaseComfirm = window.confirm("Would you like to include lowercase letters? ('OK' for Yes 'CANCEL' for No)");
  if (lowercaseComfirm){
...
var passwordDetailsUppercase = function(){
  uppercaseComfirm = window.confirm("Would you like to include uppercase letters? ('OK' for Yes 'CANCEL' for No)");
  if (uppercaseComfirm){
...
var passwordDetailsNumeric = function(){
  numericComfirm = window.confirm("Would you like to include numeric characters? ('OK' for Yes 'CANCEL' for No)");
  if (numericComfirm){
...
var passwordDetailsSpecial = function(){
  specialComfirm = window.confirm("Would you like to include special characters? ('OK' for Yes 'CANCEL' for No)");
  if (specialComfirm){
